...
def parse_args():
    ...
    # Task
    parser.add_argument('--data_mode', type=str, required=True, help="Data mode: 'rm' for reward modeling, 'conv' for conversational.")
    ...
    parser.add_argument('--reward_model_path', type=str, default='', help='reward model and reference model path')
    ...
    parser.add_argument('--base_model', type=str, default='Llama-3.2-1B-Instruct', help='base model name')
