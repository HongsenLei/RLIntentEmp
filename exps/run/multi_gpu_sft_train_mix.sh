...
# 设置数据参数
conv_train_data_path="data/conv_sft/en_ED_intent_label_SFT_train.jsonl"
rm_cot_train_data_path="data/rm_sft/preference_data_CoT_42000.jsonl"
data_mode="mix"
rm_ratio="0.8"
...
# 设置模型参数
model_name_or_path="hf_model/conv_sft_step600"
